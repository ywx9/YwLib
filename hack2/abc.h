...
#define SIGBREAK 21
#define SIGABRT 22
#pragma endregion //------------------------------------------------- [signal.h]
#pragma region[stdarg.h] -------------------------------------------------------
...
#pragma endregion //------------------------------------------------- [stdarg.h]
#pragma region[stddef.h] -------------------------------------------------------
...
extern "C" typedef struct _iobuf { void* _Placeholder; } FILE;
namespace __ywstd_cfunc { using ::FILE; }
#pragma endregion //-------------------------------------------------- [stdio.h]
#pragma region[stdlib.h] -------------------------------------------------------
#define EXIT_SUCCESS 0
#define EXIT_FAILURE 1
#define MB_CUR_MAX (_CSTD __mb_cur_max_func())
#ifndef NULL
#define NULL 0
#endif
